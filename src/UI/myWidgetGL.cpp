...
void myWidgetGL::paintGL()
{
    ...
    glClearColor(0.1f, 0.1f, 0.15f, 1.0f);                     PRINT_OPENGL_ERROR();
...
// Calcul de la normal matrix (inverse transposée de la modelview)
static cpe::mat4 build_normal_matrix(const cpe::mat4& w)
{
...
void myWidgetGL::setup_camera()
{
    ...
    projection_matrix.set_projection_perspective(55.0f * M_PI / 180.0f, ratio, 1e-4f, 100.0f);
